PhoneSmith
==========
PhoneSmith is a Python tool for generating and formatting phone numbers in multiple styles based on one area code.  Whether you're working on dialing, data analysis, CTF challenges, or penetration testing.
